...
/* ═══════════════════════════════════════════════════════
   ...
   ── A CATEGORIA DE CADA ITEM É A DO LIVRO (decidido em 07/09/2026) ──
   Os 232 itens nomeados foram conferidos um a um contra a fonte de cada
   livro: a TABELA em que o item aparece (T20 8-9/8-11/8-13/8-14/8-15 e
   Heróis 3-9/3-10/3-11/3-12) ou a frase que fecha o verbete no Deuses e no
   Ameaças ("Arma específica média, preço T$ 54.000"). Quatro estavam fora
   do lugar, e todos os quatro moravam no esotérico:

     • Cajado da destruição, Cajado da vida e Cajado do poder passaram para
       ESPEC_ARMA — o T20 os imprime na Tab. 8-9: ARMAS Específicas, e o
       verbete começa em "Este bordão…". Que eles também "contem como um
       cajado arcano" é um poder do item, não a categoria dele.
     • Varinha da generosidade passou para ACESSORIO_MEDIO — o verbete dela
       (Deuses p. 59) termina em "Acessório médio, preço T$ 30.000".

   Isso deixa ESPEC_ESOTER com os 4 itens da Tab. 3-11 do Heróis, que é o
   único livro a ter a categoria "esotérico específico": pela regra do T20
   (p. 341), "todos os itens mágicos que não são armas, armaduras, escudos,
   poções ou pergaminhos são acessórios" — e o Deuses segue essa taxonomia.

   Ao mover, valeram as duas regras que este arquivo já usava: quem ENTRA em
   ...
   faixas reescaladas proporcionalmente para voltar a fechar (ESPEC_ESOTER,
   d100 com 4 entradas).
   ═══════════════════════════════════════════════════════ */
...
const ESPEC_ARMA = [
  ...
  {max: 31, item:"Cajado da destruição",    preco:"60.000",  livro:"Tormenta20",       pag:337},
  {max: 32, item:"Cajado da vida",          preco:"60.000",  livro:"Tormenta20",       pag:337},
  {max: 33, item:"Cajado das matas",        preco:"27.000",  livro:"Deuses de Arton",  pag:55},
  {max: 34, item:"Cajado do poder",         preco:"180.000", livro:"Tormenta20",       pag:337},
  {max: 35, item:"Cimitarra solar",         preco:"54.000",  livro:"Deuses de Arton",  pag:56},
  {max: 37, item:"Clava de lava",           preco:"45.000",  livro:"Heróis de Arton",  pag:257},
  {max: 40, item:"Espada baronial",         preco:"30.000",  livro:"Tormenta20",       pag:337},
  {max: 42, item:"Espada da tempestade",    preco:"45.000",  livro:"Heróis de Arton",  pag:257},
  {max: 45, item:"Espada do guardião",      preco:"54.000",  livro:"Heróis de Arton",  pag:257},
  {max: 46, item:"Espada imaculada",        preco:"45.000",  livro:"Deuses de Arton",  pag:59},
  {max: 47, item:"Espada monástica",        preco:"54.000",  livro:"Deuses de Arton",  pag:57},
  {max: 49, item:"Espada solar",            preco:"45.000",  livro:"Heróis de Arton",  pag:257},
  {max: 52, item:"Espada sortuda",          preco:"110.000", livro:"Tormenta20",       pag:337},
  {max: 54, item:"Florete do vendaval",     preco:"27.000",  livro:"Heróis de Arton",  pag:258},
  {max: 57, item:"Florete fugaz",           preco:"50.000",  livro:"Tormenta20",       pag:337},
  {max: 58, item:"Katana da determinação",  preco:"54.000",  livro:"Deuses de Arton",  pag:57},
  {max: 61, item:"Lâmina da luz",           preco:"45.000",  livro:"Tormenta20",       pag:338},
  {max: 64, item:"Lança animalesca",        preco:"45.000",  livro:"Tormenta20",       pag:338},
  {max: 65, item:"Lança da dominação",      preco:"45.000",  livro:"Deuses de Arton",  pag:56},
  {max: 67, item:"Lança da fênix",          preco:"100.000", livro:"Heróis de Arton",  pag:258},
  {max: 70, item:"Língua do deserto",       preco:"90.000",  livro:"Tormenta20",       pag:338},
  {max: 73, item:"Maça do terror",          preco:"45.000",  livro:"Tormenta20",       pag:338},
  {max: 74, item:"Maça monstruosa",         preco:"27.000",  livro:"Deuses de Arton",  pag:58},
  {max: 75, item:"Machado da bravura",      preco:"25.000",  livro:"Deuses de Arton",  pag:55},
  {max: 77, item:"Machado da natureza",     preco:"22.500",  livro:"Heróis de Arton",  pag:258},
  {max: 79, item:"Machado do abismo",       preco:"36.000",  livro:"Heróis de Arton",  pag:258},
  {max: 82, item:"Machado do vulcão",       preco:"54.000",  livro:"Heróis de Arton",  pag:258},
  {max: 83, item:"Machado lamnoriano",      preco:"22.500",  livro:"Deuses de Arton",  pag:59},
  {max: 86, item:"Machado silvestre",       preco:"70.000",  livro:"Tormenta20",       pag:338},
  {max: 87, item:"Mangual aventureiro",     preco:"40.000",  livro:"Deuses de Arton",  pag:59},
  {max: 89, item:"Martelo da terra",        preco:"33.000",  livro:"Heróis de Arton",  pag:258},
  {max: 92, item:"Martelo de Doherimm",     preco:"70.000",  livro:"Tormenta20",       pag:338},
  {max: 94, item:"Martelo do titã",         preco:"22.500",  livro:"Heróis de Arton",  pag:258},
  {max: 95, item:"Pistola demoníaca",       preco:"72.250",  livro:"Ameaças de Arton", pag:403},
  {max: 97, item:"Punhal das profundezas",  preco:"36.000",  livro:"Heróis de Arton",  pag:258},
  {max:100, item:"Punhal sszzaazita",       preco:"100.000", livro:"Tormenta20",       pag:338},
  {max:101, item:"Tridente aquoso",         preco:"54.000",  livro:"Deuses de Arton",  pag:58},
  {max:102, item:"Uyzrrak Da’ukthra",       preco:"78.050",  livro:"Ameaças de Arton", pag:403},
  {max:105, item:"Vingadora sagrada",       preco:"200.000", livro:"Tormenta20",       pag:338},
];
...
const ESPEC_ESOTER = [
  {max: 14, item:"Cajado das marés",     preco:"27.000",  livro:"Heróis de Arton", pag:262},
  {max: 57, item:"Cálice sagrado",       preco:"150.000", livro:"Heróis de Arton", pag:262},
  {max: 86, item:"Relógio do arcanista", preco:"60.000",  livro:"Heróis de Arton", pag:262},
...
const ACESSORIO_MEDIO = [
  ...
  {max:102, item:"Varinha da generosidade",        preco:"30.000", livro:"Deuses de Arton",  pag:59},
];
